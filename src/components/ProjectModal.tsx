...
import { Icon, IconArrowUpRight, IconCheck, IconClose } from "./icons";
            ...
            <div className="no-scrollbar flex-1 overflow-y-auto p-6 sm:p-7">
              ...
              <div className="mt-6 space-y-7">
                ...
                {project.architecture && (
                  <CaseBlock label="System design">
                    <p
                      className="text-sm leading-relaxed font-mono text-[13px]"
                      style={{ color: "var(--fg-muted)" }}
                    >
                      {project.architecture}
                    </p>
                ...
                {project.engineeringDecisions &&
                  project.engineeringDecisions.length > 0 && (
                    <CaseBlock label="Key engineering decisions">
                ...
                {project.challenges && project.challenges.length > 0 && (
                  <CaseBlock label="Challenges & solutions">
                    <ul className="space-y-3">
                ...
                {(project.highlights?.length ?? 0) > 0 && (
                  <CaseBlock label="Technical highlights">
